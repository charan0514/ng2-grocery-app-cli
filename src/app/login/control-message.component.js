...
var ControlMessagesComponent = (function () {
    ...
    ControlMessagesComponent.prototype.get = function () {
        for (var propertyName in this.control.errors) {
            if (this.control.errors.hasOwnProperty(propertyName) && this.control.touched) {
                return login_service_1.LoginService.getValidatorErrorMessage(propertyName, this.control.errors[propertyName]);
            }
        }
        return null;
    };
